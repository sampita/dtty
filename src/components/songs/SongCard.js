    ...
    return (
      <>
        <article
          ...
          onClick={e => this.handleSelectedSongChange(e)}
        >
          <div className="cardContent">
            ...
            <p className="lastUpdatedText">
              Last updated {moment(this.props.song.lastUpdated).format('MMMM D, YYYY')}
            </p>
          ...
          {this.state.isSongSelected ? (
            <div>
              <div id="audioFlexContainer">
                <audio id="player" controls src={this.props.song.audio}></audio>
              </div>
