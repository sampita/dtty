          ...
          <div className="ui equal width grid">
            <div className="column" id="backButtonColumn">
              <FontAwesomeIcon
                ...
                id="backButton"
                onClick={evt => {
                  this.props.updateSongAndReturnToHome(evt)
                }}
              />
            </div>
            <section className="column">
              ...
              <div>
                <span className="boldText nextLine">Verse:</span>
                {this.state.verse}
              </div>
              <div>
                <span className="boldText nextLine">Chorus:</span>
                {this.state.chorus}
              </div>
              <div>
                <span className="boldText nextLine">Bridge:</span>
                {this.state.bridge}
              </div>
            </section>
            <section className="column">
              <span className="boldText">Written By:</span>
